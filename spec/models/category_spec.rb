...
describe Category do
  ...
  describe "#recent_videos" do
    it "should returns the videos in the reverse chronical order by created at" do
    ...
    it "returns the most recent 6 videos" do
      ...
      tonights_show = Video.create(title: "Tonights Episode", description: "bar", category: comedies, created_at: 1.day.ago)
